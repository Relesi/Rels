...
import com.relesi.rels.api.responses.Response;
...
public class ClienteController {
	...
	public ResponseEntity<Response<Integer>> remover(@PathVariable(name = "id") String id, @RequestBody Cliente cliente) {
